...
☄️ Asteroids — a modern, dependency-free HTML5 game built with Canvas and vanilla JavaScript.

🎮 **Play Online:** https://gamelabz.github.io/html5-game-asteroids/

## 📸 Screenshot

![Asteroids](assets/images/screenshot.png)

## 🎯 About

Pilot your ship, blast drifting asteroids into fragments, and survive the ever-growing field.
...
- Inertia-based ship physics
- Splitting asteroid fragments
- Wrap-around screen and particles
