...
☄️ Asteroids — یک بازی HTML5 مدرن و بدون وابستگی، ساخته‌شده با Canvas و جاوااسکریپت خالص.

🎮 **بازی آنلاین:** https://gamelabz.github.io/html5-game-asteroids/
...
سفینه‌ات را هدایت کن، سیارک‌های سرگردان را به تکه‌های کوچکتر منفجر کن و از میدان رو به رشد جان سالم به در ببر.

## 🕹️ کنترل‌ها

- چرخش: کلیدهای چپ/راست
- پیشران: بالا
- شلیک: Space
- هایپراسپیس: Shift
...
- فیزیک سفینه بر پایه اینرسی
- تکه‌تکه شدن سیارک‌ها
- صفحه چرخ‌دار و ذرات
